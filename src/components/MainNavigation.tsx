...
const BottomNav = styled.nav<{ $isDark: boolean }>`
  position: fixed;
  bottom: 0;
  left: 0;
  right: 0;
  background: ${props => props.$isDark ? theme.colors.dark.surfaceGlass : theme.colors.light.surfaceGlass};
  backdrop-filter: blur(20px);
  border-top: 1px solid ${props => props.$isDark ? theme.colors.dark.border : theme.colors.light.border};
  ...
  @media (min-width: 768px) {
    ...
    border-left: 1px solid ${props => props.$isDark ? theme.colors.dark.border : theme.colors.light.border};
    border-right: 1px solid ${props => props.$isDark ? theme.colors.dark.border : theme.colors.light.border};
  }
`;
